...
Before running the API provider you need to open the xref:samples2:reference/meta-model-model-api.adoc[MPS project] in the `mps` folder.
...
Alternatively you can now start the xref:samples2:reference/dashboard.adoc[] to consume this API endpoint.
